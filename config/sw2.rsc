# jan/01/2002 04:05:07 by RouterOS 6.35.4
# software id = DYT5-WMHZ
#
/interface ethernet
set [ find default-name=ether1 ] advertise=\
    ...
    full-duplex=yes l2mtu=1588 mac-address=E4:8D:8C:A4:8F:87 master-port=none \
    mtu=1500 name=ether1-master orig-mac-address=E4:8D:8C:A4:8F:87 \
    rx-flow-control=off speed=100Mbps tx-flow-control=off
set [ find default-name=ether2 ] advertise=\
    10M-half,10M-full,100M-half,100M-full,1000M-half,1000M-full arp=enabled \
    auto-negotiation=yes bandwidth=unlimited/unlimited disabled=no \
    full-duplex=yes l2mtu=1588 mac-address=E4:8D:8C:A4:8F:88 master-port=\
    ether1-master mtu=1500 name=ether2 orig-mac-address=E4:8D:8C:A4:8F:88 \
    rx-flow-control=off speed=100Mbps tx-flow-control=off
set [ find default-name=ether3 ] advertise=\
    10M-half,10M-full,100M-half,100M-full,1000M-half,1000M-full arp=enabled \
    auto-negotiation=yes bandwidth=unlimited/unlimited disabled=no \
    full-duplex=yes l2mtu=1588 mac-address=E4:8D:8C:A4:8F:89 master-port=\
    ether1-master mtu=1500 name=ether3 orig-mac-address=E4:8D:8C:A4:8F:89 \
    rx-flow-control=off speed=100Mbps tx-flow-control=off
set [ find default-name=ether4 ] advertise=\
    10M-half,10M-full,100M-half,100M-full,1000M-half,1000M-full arp=enabled \
    auto-negotiation=yes bandwidth=unlimited/unlimited disabled=no \
    full-duplex=yes l2mtu=1588 mac-address=E4:8D:8C:A4:8F:8A master-port=\
    ether1-master mtu=1500 name=ether4 orig-mac-address=E4:8D:8C:A4:8F:8A \
    rx-flow-control=off speed=100Mbps tx-flow-control=off
set [ find default-name=ether5 ] advertise=\
    10M-half,10M-full,100M-half,100M-full,1000M-half,1000M-full arp=enabled \
    auto-negotiation=yes bandwidth=unlimited/unlimited disabled=no \
    full-duplex=yes l2mtu=1588 mac-address=E4:8D:8C:A4:8F:8B master-port=\
    ether1-master mtu=1500 name=ether5 orig-mac-address=E4:8D:8C:A4:8F:8B \
    rx-flow-control=off speed=100Mbps tx-flow-control=off
set [ find default-name=ether6 ] advertise=\
    10M-half,10M-full,100M-half,100M-full,1000M-half,1000M-full arp=enabled \
    auto-negotiation=yes bandwidth=unlimited/unlimited disabled=no \
    full-duplex=yes l2mtu=1588 mac-address=E4:8D:8C:A4:8F:8C master-port=\
    ether1-master mtu=1500 name=ether6 orig-mac-address=E4:8D:8C:A4:8F:8C \
    rx-flow-control=off speed=100Mbps tx-flow-control=off
set [ find default-name=ether7 ] advertise=\
    10M-half,10M-full,100M-half,100M-full,1000M-half,1000M-full arp=enabled \
    auto-negotiation=yes bandwidth=unlimited/unlimited disabled=no \
    full-duplex=yes l2mtu=1588 mac-address=E4:8D:8C:A4:8F:8D master-port=\
    ether1-master mtu=1500 name=ether7 orig-mac-address=E4:8D:8C:A4:8F:8D \
    rx-flow-control=off speed=100Mbps tx-flow-control=off
set [ find default-name=ether8 ] advertise=\
    10M-half,10M-full,100M-half,100M-full,1000M-half,1000M-full arp=enabled \
    auto-negotiation=yes bandwidth=unlimited/unlimited disabled=no \
    full-duplex=yes l2mtu=1588 mac-address=E4:8D:8C:A4:8F:8E master-port=\
    ether1-master mtu=1500 name=ether8 orig-mac-address=E4:8D:8C:A4:8F:8E \
    rx-flow-control=off speed=100Mbps tx-flow-control=off
set [ find default-name=sfp-sfpplus1 ] advertise=\
    10M-half,10M-full,100M-half,100M-full,1000M-half,1000M-full arp=enabled \
    auto-negotiation=yes bandwidth=unlimited/unlimited disabled=no \
    full-duplex=yes l2mtu=1588 mac-address=E4:8D:8C:A4:8F:8F master-port=\
    ether1-master mtu=1500 name=sfp-sfpplus1 orig-mac-address=\
    E4:8D:8C:A4:8F:8F rx-flow-control=off sfp-rate-select=high speed=10Gbps \
    tx-flow-control=off
set [ find default-name=sfpplus2 ] advertise=\
    10M-half,10M-full,100M-half,100M-full,1000M-half,1000M-full arp=enabled \
    auto-negotiation=yes bandwidth=unlimited/unlimited disabled=no \
    full-duplex=yes l2mtu=1588 mac-address=E4:8D:8C:A4:8F:90 master-port=\
    ether1-master mtu=1500 name=sfpplus2 orig-mac-address=E4:8D:8C:A4:8F:90 \
...
set *FFFFFFFE address-list="" !bridge !bridge-path-cost !bridge-port-priority \
    ...
    !rate-limit !remote-address remote-ipv6-prefix-pool=none !session-timeout \
...
set bridge-type=customer-vid-used-as-lookup-vid \
    ...
    egress-mirror0=sw2-cpu,modified egress-mirror1=sw2-cpu,modified fdb-uses=\
    mirror0 forward-unknown-vlan=yes ingress-mirror-ratio=1/1 \
    ingress-mirror0=sw2-cpu,unmodified ingress-mirror1=sw2-cpu,unmodified \
    ...
    dst-ip-and-vid-for-ipv4 name=sw2 override-existing-when-ufdb-full=no \
...
set allow-fast-path=no authentication=pap,chap,mschap1,mschap2 \
    ...
    max-mru=1450 max-mtu=1450 max-sessions=unlimited mrru=disabled use-ipsec=\
    no
/interface ovpn-server server
set auth=sha1,md5 cipher=blowfish128,aes128 default-profile=default enabled=\
    no keepalive-timeout=60 mac-address=FE:16:C1:13:B1:05 max-mtu=1500 mode=\
...
/ip address
add address=172.18.1.12/16 comment="sw2 management" disabled=no interface=\
...
/snmp
set contact=oherrala@gmail.com enabled=no engine-id="" location=sauna \
